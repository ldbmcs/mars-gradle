...
import com.ldbmcs.mars.gradle.graphql.common.exceptions.ServiceWithDetailException;
...
@Getter
public class CodedExceptionWhileDataFetching implements GraphQLError {
    ...
    public CodedExceptionWhileDataFetching(ResultPath path, Throwable exception, SourceLocation sourceLocation) {
